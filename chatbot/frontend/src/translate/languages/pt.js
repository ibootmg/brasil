    ...
    translations: {
      ...
      login: {
        ...
        buttons: {
          ...
          register: "CADASTRE-SE GRATUITAMENTE!",
        },
      },
      companies: {
      ...
      connections: {
        ...
        confirmationModal: {
          ...
          deleteTitle: "Deletar",
          deleteMessage: "⚠️ Tem certeza disso? Esta ação é irreversível e irá excluir todos os seus tickets, contatos e muito mais. Por favor, tenha cautela.",
          disconnectTitle: "Desconectar",
          disconnectMessage:
          "Tem certeza? Você precisa escanear o QR Code novamente. Antes de prosseguir, verifique os tickets abertos e os que estão aguardando atenção."
        },
        buttons: {
      ...
      whatsappModal: {
        ...
        tabs: {
          ...
          completionMessage: "Conclusão",
          ratingMessage: "Avaliação",
          inactiveMessage: "Inatividade",
      ...
      contacts: {
        ...
        toasts: {
          ...
          deletedSelected: "Contatos selecionados foram excluídos com sucesso!"
        },
      ...
      messagesInput: {
        placeholderPrivateMessage:
          "Mensagem ou aperte / para respostas rápidas",
        placeholderOpen:
          "Mensagem ou aperte / para respostas rápidas",
        placeholderClosed:
