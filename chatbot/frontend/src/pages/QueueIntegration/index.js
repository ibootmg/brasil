    ...
    <MainContainer>
      ...
      <MainHeader>
        ...
        <MainHeaderButtonsWrapper>
          ...
          <Button // Novo botão para ativar/desativar o modo de edição
            variant="contained"
            color="secondary"
            onClick={() => setEditMode(prevState => !prevState)}
          >
            {editMode ? "Desativar Modo Edição" : "Ativar Modo Edição"}
          </Button>
        </MainHeaderButtonsWrapper>
      </MainHeader>
      <Paper
                ...
                <TableRow key={integration.id}>
                  ...
                  <TableCell align="center">
                    <IconButton
                      ...
                      disabled={!editMode} // Desativar o botão se não estiver no modo de edição
                    >
