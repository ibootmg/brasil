...
#  
#  print_banner
#  printf "${WHITE} 💻 Insira o link do GITHUB do WhiteLabel que deseja instalar:${GRAY_LIGHT}"
#  printf "\n\n"
#  read -p "> " link_git
#}
...
get_instancia_add() {
  ...
  print_banner
  printf "${WHITE} 💻 Informe um nome para a Instância/Empresa que será instalada ( Sem caracteres especiais; letras minusculas):${GRAY_LIGHT}"
  printf "\n\n"
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador WhiteLabel, selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [1] Instalar WhiteLabel\n"
  printf "   [2] Atualizar WhiteLabel\n"
  #printf "   [3] Deletar WhiteLabel\n"
  #printf "   [4] Bloquear WhiteLabel\n"
  #printf "   [5] Desbloquear WhiteLabel\n"
  #printf "   [6] Alter. dominio WhiteLabel\n"
  printf "\n"
  read -p "> " option
