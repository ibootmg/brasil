...
system_mv_folder() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código WhiteLabel...${GRAY_LIGHT}"
  printf "\n\n"
...
#   None
#######################################
system_unzip_chatbot() {
  print_banner
  printf "${WHITE} 💻 Extraindo o WhiteLabel...${GRAY_LIGHT}"
  printf "\n\n"
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema WhiteLabel...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos deletar uma Instância do WhiteLabel...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Bloquear o WhiteLabel...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o WhiteLabel de uma Instância...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos alterar os domínios do WhiteLabel de uma Instância...${GRAY_LIGHT}"
  printf "\n\n"
